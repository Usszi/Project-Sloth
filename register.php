<?php 
	print '
	<h1><font color=darkgreen>Registration Form</font></h1>
	<div id="register">';
	...
	if ($_POST['_action_'] == FALSE) {
		...
		<form action="" id="registration_form" name="registration_form" method="POST">
			...
			<label for="username"><font color=lime>Username:*</font> <small>(Username must have min 5 and max 10 char)</small></label>
			<input type="text" id="username" name="username" pattern=".{5,10}" placeholder="Username.." required><br>
			
									
			<label for="password"><font color=lime>Password:*</font> <small>(Password must have min 4 char)</small></label>
